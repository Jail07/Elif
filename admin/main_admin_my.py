...
from admin.configE import ADMINS
from database import create_table, add_stuff, delete_from_db, show_details
from database import order, completed_project, failed_project
from database import create_conn
from sqlite3 import Error
import sqlite3
from telebot.types import InlineKeyboardMarkup, InlineKeyboardButton

bot = telebot.TeleBot('6870134221:AAHZQF7Vx1obMH2mgYHvVKHdsCboIoYo6jU')
project = []
project_details = []
messages_to_delete = []
user_message_stack = {}
